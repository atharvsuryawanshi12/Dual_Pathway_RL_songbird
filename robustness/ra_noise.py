...
class Environment:
    ...
    def save_trajectory(self, syll):
        ...
        #         os.remove(os.path.join(save_dir, filename))
        # Save the plot
        plt.savefig(os.path.join(save_dir, f"trajectory_{self.seed}_{RA_NOISE}.png"))
    ...
    def save_results(self, syll):
        ...
        #         os.remove(os.path.join(save_dir, filename))
        # Save the plot
        plt.savefig(os.path.join(save_dir, f"results_{self.seed}_{RA_NOISE}.png"))
        plt.close()  # Close the plot to avoid memory leaks
    ...
    def save_dw_day(self, syll):
        if ANNEALING:
            ...
            #         os.remove(os.path.join(save_dir, filename))
            # Save the plot
            plt.savefig(os.path.join(save_dir, f"dw_{self.seed}_{RA_NOISE}.png"))
            plt.close()  # Close the plot to avoid memory leaks         
