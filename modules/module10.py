# Module for clusters of 10
'''Works as a module10 for the main script'''
...
BG_sig_mid = 0
RA_sig_slope = 20 # most steep such that MC output is not skewed
RA_sig_mid = 0
# Sigmoid on MC is removed
MC_sig_slope = 4.5 # 5 if lesser -> more difficult to climb the hill, assymptotes before 
MC_sig_mid = 0
...
def build_and_run10(seed, annealing, plot):
